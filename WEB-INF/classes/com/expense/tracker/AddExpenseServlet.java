...
public class AddExpenseServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String expenseTitle = request.getParameter("expense-title");
        double expenseAmount = Double.parseDouble(request.getParameter("expense-amount"));
        ...
        try {
            ...
            // Prepare SQL query to insert expense data
            String sql = "INSERT INTO expenses (title, amount, date) VALUES (?, ?, ?)";
            PreparedStatement statement = connection.prepareStatement(sql);
            statement.setString(1, expenseTitle);
            statement.setDouble(2, expenseAmount);
            statement.setString(3, expenseDate);
            ...
            response.sendRedirect("index.html");  // Redirecting to index.html after submitting expense form.
